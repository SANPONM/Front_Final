  ...
  const CarCard = ({ car }) => (
    <div className="flex-shrink-0 w-full md:w-[calc(100%/3-1rem)] bg-white rounded-lg shadow-lg p-4 transition-transform duration-300 hover:scale-105">
      ...
      <div className="flex gap-3">
        ...
        <button className="flex-1 bg-gray-200 py-2 rounded hover:bg-gray-300 transition">
          Build
        </button>
      </div>
    </div>
      ...
      <section className="bg-gray-100 py-24">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-16">
            <h1 className="text-5xl font-bold mb-6">Explore the road like never before</h1>
